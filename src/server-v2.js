...
PRONUNCIATION GUIDE - Jenny must say these words correctly:
- Com Tam Bros = say "Gum Tum Bros"
- Pho = say "Fuh"
- Pho Tai = say "Fuh Tie"
- Pho Chin = say "Fuh Chin"
- Pho Bo Vien = say "Fuh Baw Vee-en"
- Pho Dac Biet = say "Fuh Dak Byet"
- Pho Ga = say "Fuh Ga"
- Bun = say "Boon"
- Cha Gio = say "Cha Yo"
- Goi Cuon = say "Goy Coon"
- Suon Nuong = say "Shone Noong"
- Ga Nuong = say "Ga Noong"
- Com Tam = say "Gum Tum"
- When Jenny says any of these words out loud in the reply field, she must use the phonetic spelling instead of the Vietnamese spelling so Marin voice pronounces it correctly.
    ...
    if (finalize) {
      ...
      for (const text of spokenTexts) {
        ...
        if (!forceSay && BASE_URL) {
          ...
          gather.say({ voice: FALLBACK_VOICE || VOICE, language: "en-US" }, text);
        }
      }
    }
  }
